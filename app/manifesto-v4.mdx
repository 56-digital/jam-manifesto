...
You say out loud *cut the drums, add an <Annotate term="envelope filter">envelope filter</Annotate>*. As you finish the sentence, the music starts changing. No cables or menus, the distance between the thought and the sound had collapsed to the length of a sentence.
