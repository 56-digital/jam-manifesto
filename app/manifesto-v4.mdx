...
I have a cable in my hand and imagine a signal path in my mind, then I plug the cable into the desired output. I listen carefully as each new connection changes the sound. I listen through a series of small decisions. I turn knobs and press buttons to manage the depth of the attenuator. I verify the signal is going where I want it to go by following LED lights through different physical modules.
